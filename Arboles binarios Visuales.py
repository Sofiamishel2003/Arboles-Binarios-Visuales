...
#Fin:Desarrolla algoritmos computacionales creando soluciones en un lenguaje de programación.
#Lenguaje: python
#Net Framewor: 4.5
#Recursos: visual studio
#Descripción:Es una estructura de datos jerárquica donde cada elemento puede tener uno o más descendientes. Al primer elemento se le llama raíz, ademas los elementos que no tienen descendientes se les llama hojas, los que no son ni raíz ni hojas les podemos llamar ramas.
#Ultima modificación 16/09/2021